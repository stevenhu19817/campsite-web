...
<title>營地資料新增 - addCampsite.jsp</title>
		...
		<table>
			...
			<tr>
				...
				<td><input type="TEXT" name="location" size="45"
					value="<%=(campsiteVO == null) ? "台北市中山區南京東路三段219號5樓" : campsiteVO.getLocation()%>" /></td>
			</tr>
			<tr>
				<td>經度:</td>
			...
			<tr>
				...
				<td><input type="TEXT" name="campDescription" size="45"
					value="<%=(campsiteVO == null) ? "這裡是TibameTest" : campsiteVO.getCampDescription()%>" /></td>
			</tr>
			<tr>
				<td>營地價格:</td>
			...
			<tr>
				...
				<td><select size="1" name="siteState">
						<option value="1" selected>營業中</option>
