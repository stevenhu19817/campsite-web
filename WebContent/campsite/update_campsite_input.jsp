...
<%
	CampsiteVO campsiteVO = (CampsiteVO) request.getAttribute("campsiteVO"); //CampsiteServlet.java (Concroller) 存入req的empVO物件 (包括幫忙取出的empVO, 也包括輸入資料錯誤時的empVO物件)
%>

<html>
<head>
<meta http-equiv="X-UA-Compatible" content="IE=edge,chrome=1" />
<title>營地資料修改 - update_campsite_input.jsp</title>
...
<body bgcolor='white'>
	...
	<table id="table-1">
		<tr>
			<td>
				<h3>營地資料修改 - update_campsite_input.jsp</h3>
				<h4>
		...
		<table>
			...
			<tr>
				...
				<td><select size="1" name="siteState">
						...
						<option value="0" ${campsiteVO.getSiteState()==0?'selected':''}>休息中</option>
				</select></td>
			</tr>
			<tr>
				<td>喜歡人數:</td>
