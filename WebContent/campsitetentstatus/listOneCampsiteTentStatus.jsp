...
<%
	List<CampsiteTentStatusVO> list = (List<CampsiteTentStatusVO>) request
			.getAttribute("campsiteTentStatusList");
...
<body bgcolor='white'>
	...
	<table>
		...
		<c:forEach var="campsiteTentStatusVO" items="${list}" begin="<%=pageIndex%>" end="<%=pageIndex+rowsPerPage-1%>">
			<tr>
