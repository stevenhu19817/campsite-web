...
<header class="header" id="gocamping">
  <h1 class="header__title">Go camping帳篷狀態新增</h1><br>
  <table id="table-1">
...
<!--           </div> -->
          ...
          <div class="col-md-6">
            ...
            <input type="text" class="form-control" name="emptyCampLeft" id="emptyCampLeft" placeholder="請輸入人數..." value="">
          </div>
